...
Window::Window(const EngineContext& context, const Extent& windowExtent,
    const std::string& windowText, const Attributes& attr)
{
    init(context, windowExtent, windowText, attr);
}

void Window::init(const EngineContext& context, const Extent& windowExtent,
    const std::string& windowText, const Attributes& attr)
{
...
void Window::destroy(const EngineContext& context)
{
    if (!m_initialized)
        return;
