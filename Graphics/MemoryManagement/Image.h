...
namespace Graphics {
    ...
    public:
        ...
        Image(const Context& instance, const Device& device, const std::string& filepath);
        ...
        void load(const Context& instance, const Device& device, const std::string& filepath);
