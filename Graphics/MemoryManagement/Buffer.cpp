...
namespace Graphics {
    ...
    Buffer::Buffer(const Context& instance, const Device& device,
    ...
    Buffer::Buffer(const Context& instance, const Device& device, Descriptor descriptor) :
    ...
    //void Buffer::allocateMemory(const Context& instance, const Device& device,
