...
Buffer::Buffer(const GraphicsContext& instance, const Device& device,
...
Buffer::Buffer(const GraphicsContext& instance, const Device& device, Descriptor descriptor) :
...
//void Buffer::allocateMemory(const GraphicsContext& instance, const Device& device,
