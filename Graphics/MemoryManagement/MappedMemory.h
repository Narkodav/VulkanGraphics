...
public:
    ...
    MappedMemory(const GraphicsContext& instance, const Device& device,
    ...
    bool bindBuffer(const GraphicsContext& instance, const Device& device,
        const Buffer& buffer, size_t offset = 0);

    bool bindImage(const GraphicsContext& instance, const Device& device,
