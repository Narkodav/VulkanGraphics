...
void PhysicalDevice::enumerateFeatures(const GraphicsContext& instance)
{
    ...
    // Store Vulkan 1.2 indexing features
    {
        ...
        storeFeature(DeviceFeature::DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT,
            static_cast<bool>(descriptorIndexingFeatures.descriptorBindingVariableDescriptorCount));
        storeFeature(DeviceFeature::SHADER_SAMPLED_IMAGE_ARRAY_NON_UNIFORM_INDEXING,
...
void PhysicalDevice::enumerateProperties(const GraphicsContext& instance)
{
...
void PhysicalDevice::enumerateExtensions(const GraphicsContext& instance)
{
    // Get extension count
...
void PhysicalDevice::enumerateQueueFamilies(const GraphicsContext& instance)
{
