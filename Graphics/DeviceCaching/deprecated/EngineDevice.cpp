...
bool Device::evaluateDevice(vk::PhysicalDevice device, const GraphicsContext& instance, const Window& window,
...
void Device::selectPhysicalDevice(const GraphicsContext& instance,
	const Window& window)
{
...
void Device::createLogicalDevice(const GraphicsContext& instance,
	const Window& window)
{
...
#ifdef _DEBUG
	createInfo.enabledLayerCount = static_cast<uint32_t>(GraphicsContext::validationLayers.size());
	createInfo.ppEnabledLayerNames = GraphicsContext::validationLayers.data();
#else
...
vk::DeviceMemory Device::allocateMemory(const GraphicsContext& instance,
...
uint32_t Device::findMemoryType(const GraphicsContext& instance,
...
vk::Format Device::findSupportedFormat(const GraphicsContext& instance, 
