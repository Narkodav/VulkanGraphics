...
template<> struct DeviceFeatureTypeTrait<DeviceFeature::DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT> { using Type = bool; };
template<> struct DeviceFeatureTypeTrait<DeviceFeature::SHADER_SAMPLED_IMAGE_ARRAY_NON_UNIFORM_INDEXING> { using Type = bool; };
