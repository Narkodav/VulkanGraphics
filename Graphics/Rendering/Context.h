...
namespace Graphics {
    ...
    private:
        ...
        Context** m_enginePointer = nullptr;
    ...
    public:
        ...
        Context(const std::string& engineName, const std::string& appName,
        ...
        Context& operator=(Context&& other) noexcept
        {
            ...
            assert(!m_initialized && "Context::operator=() - Context already initialized");
        ...
        ~Context() { assert(!m_initialized && "Context was not destroyed!"); };
