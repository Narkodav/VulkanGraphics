...
void CommandBuffer::record(const GraphicsContext& instance, CommandBufferUsage::Flags flags)
{
...
void CommandBuffer::beginRenderPass(const GraphicsContext& instance,
...
void CommandBuffer::bindGraphicsPipeline(const GraphicsContext& instance, const GraphicsPipeline& pipeline)
{
	try {
...
void CommandBuffer::bindIndexBuffer(const GraphicsContext& instance,
...
void CommandBuffer::bindDescriptorSets(const GraphicsContext& instance,
...
void CommandBuffer::setPipelineBarrier(const GraphicsContext& instance,
...
void CommandBuffer::transferBufferData(const GraphicsContext& instance, const Buffer& srcBuffer,
...
void CommandBuffer::transferImageData(const GraphicsContext& instance, const Buffer& srcBuffer,
...
void CommandBuffer::setRenderView(const GraphicsContext& instance, const RenderRegion& canvas)
{
...
void CommandBuffer::draw(const GraphicsContext& instance,
...
void CommandBuffer::drawIndexed(const GraphicsContext& instance,
...
void CommandBuffer::endRenderPass(const GraphicsContext& instance)
{
	try {
...
void CommandBuffer::stopRecord(const GraphicsContext& instance)
{
	try {
...
void CommandBuffer::reset(const GraphicsContext& instance)
{
	try {
...
//CommandBuffer allocateBuffer(const GraphicsContext& instance, const Device& device,
...
//}
//
//void freeBuffer(const GraphicsContext& instance, const Device& device, CommandBuffer& buffer) {
//
