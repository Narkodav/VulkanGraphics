...
namespace Graphics {
	void CommandBuffer::record(const Context& instance, CommandBufferUsage::Flags flags)
	{
	...
	void CommandBuffer::beginRenderPass(const Context& instance,
	...
	void CommandBuffer::draw(const Context& instance,
	...
	void CommandBuffer::drawIndexed(const Context& instance,
	...
	void CommandBuffer::endRenderPass(const Context& instance)
	{
		try {
	...
	void CommandBuffer::stopRecord(const Context& instance)
	{
		try {
	...
	void CommandBuffer::reset(const Context& instance)
	{
		try {
	...
	//CommandBuffer allocateBuffer(const Context& instance, const Device& device,
	...
	//}
	//
	//void freeBuffer(const Context& instance, const Device& device, CommandBuffer& buffer) {
	//
