...
Fence::Fence(const GraphicsContext& instance, const Device& device, bool createSignaled/* = false*/)
{
...
void Fence::wait(const GraphicsContext& instance, const Device& device)
{
...
void Fence::reset(const GraphicsContext& instance, const Device& device)
{
