...
namespace Graphics {
	...
	vk::DeviceMemory Device::allocateMemory(const Context& instance,
	...
	uint32_t Device::findMemoryType(const Context& instance,
	...
	vk::Format Device::findSupportedFormat(const Context& instance,
