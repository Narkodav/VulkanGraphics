...
public:
    ...
    CommandPool(const GraphicsContext& instance, const Device& device, uint32_t queueFamilyIndex);
    ...
    CommandBufferHandle allocateBuffer(const GraphicsContext& instance, const Device& device,
    ...
    void freeBuffer(const GraphicsContext& instance, const Device& device, CommandBufferHandle& buffer) {
    ...
    void makeOneTimeSubmit(const GraphicsContext& instance, const Device& device,
        const Queue& queue, std::function<void(const CommandBufferHandle&)>&& func);

    template <typename Type, typename Data>
    void makeOneTimeDataTransfer(const GraphicsContext& instance, const Device& device,
