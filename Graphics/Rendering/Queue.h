...
namespace Graphics {
    ...
    public:
        ...
        Queue() {};
        Queue(const Context& instance, const Device& device,
        ...
        void waitIdle(const Context& instance) const { m_queue.waitIdle(instance.getDispatchLoader()); };

        void submit(const Context& instance,
