...
namespace Graphics {
    ...
    std::vector<vk::LayerProperties> Context::getAvailableValidationLayers() {
        try {
            uint32_t layerCount;
    ...
    std::vector<const char*> Context::validateLayers(std::vector<vk::LayerProperties>& availible)
    {
    ...
    std::vector<vk::ExtensionProperties> Context::getAvailableExtensions()
    {
        try {
    ...
    void Context::validateExtensions(
    ...
    vk::ApplicationInfo Context::getAppInfo(const std::string& engineName,
    ...
    vk::InstanceCreateInfo Context::getInstanceCreateInfo(vk::ApplicationInfo& appInfo,
        std::vector<const char*>& requiredExtensions,
    ...
    vk::Instance Context::getInstance(const std::string& engineName,
        const std::string& appName, Version& engineVersion, Version& appVersion,
        vk::DebugUtilsMessengerCreateInfoEXT* debugCreateInfo /*= nullptr*/)
    {
    ...
    vk::detail::DispatchLoaderDynamic Context::getDispatchLoader(
    ...
    vk::DebugUtilsMessengerCreateInfoEXT Context::getDebugCreateInfo(
    ...
    Context::Context(const std::string& engineName, const std::string& appName,
    ...
    void Context::setDebugSeverityThreshold(DebugMessageSeverity::Flags severitySettings)
    {
#ifdef _DEBUG
    ...
    VKAPI_ATTR vk::Bool32 VKAPI_CALL Context::static_debugCallback(
