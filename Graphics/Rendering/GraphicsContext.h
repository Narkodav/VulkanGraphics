...
private:
    ...
    GraphicsContext** m_enginePointer = nullptr;
...
public:
    ...
    GraphicsContext() : m_instance(nullptr) 
#ifdef _DEBUG
    ,  m_debugMessenger(nullptr)
#endif
    {};

    GraphicsContext(const std::string& engineName, const std::string& appName,
    ...
    GraphicsContext& operator=(GraphicsContext&& other) noexcept
    {
        ...
        assert(!m_initialized && "GraphicsContext::operator=() - GraphicsContext already initialized");
    ...
    ~GraphicsContext() { assert(!m_initialized && "GraphicsContext was not destroyed!"); };
