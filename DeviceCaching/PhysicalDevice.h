...
public:
	...
	PhysicalDevice(const EngineContext& instance, vk::PhysicalDevice device) :
	...
	SwapChainSupportDetails getSwapChainSupportDetails(
		const EngineContext& instance, const Window& window) const
	{
...
private:
	...
	void enumerateFeatures(const EngineContext& instance);
	void enumerateProperties(const EngineContext& instance);
	void enumerateExtensions(const EngineContext& instance);
	void enumerateQueueFamilies(const EngineContext& instance);
