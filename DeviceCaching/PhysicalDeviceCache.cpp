...
PhysicalDeviceCache::PhysicalDeviceCache(const EngineContext& instance)
{
...
DeviceSearchResult PhysicalDeviceCache::getFittingDevice(const EngineContext& instance,
...
DeviceSearchResult PhysicalDeviceCache::checkDeviceSuitability(const EngineContext& instance,
	const Window& window, const DeviceRequirements& requirements,
...
bool PhysicalDeviceCache::checkQueueFamilySuitability(const EngineContext& instance,
